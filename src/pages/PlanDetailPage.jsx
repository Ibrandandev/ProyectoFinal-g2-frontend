            ...
            <div className="container text-white">
                ...
                <div className="row mt-4 ">
                    <div className="col-12 col-lg-5 justify-content-md-center">
                        <img className="w-100" src={data[0].img} alt="" />
                    </div>
                    <div className="col-12 col-lg-7 mt-3">
                        <div className="d-flex justify-content-between rowTitulo">
                            <h1 className="rowTitulo mx-4 m-2">{data[0].nombre}</h1>
                            <h2 className="rowTitulo align-self-center mx-5 m-2">${data[0].precio}</h2>
                        </div>
                        <div>
                            <h5 className="mt-3 mx-3">{data[0].duracion}</h5>
                        </div>
                        <div>
                ...
                <form className="row g-3 justify-content-center" onSubmit={sendEmail}>
                    <div className="row">
                        <div className="col-12 col-md-6">
                            ...
                            <input type="text" className="form-control" id="nombre" placeholder="Nombre" onChange={handleChange} value={formValues.nombre} required/>
                        </div>
                        <div className="col-12 col-md-6">
                        ...
                        <div className="col-12 col-md-6">
                            ...
                            <div className="input-group">
                                ...
                                <input type="email" className="form-control" id="destinatario" aria-describedby="inputGroupPrepend2" placeholder="Correo" onChange={handleChange} value={formValues.destinatario} required/>
                            </div>
                        </div>
                        <div className="col-12 col-md-6">
                        ...
                        <div className="col mb-3">
                            ...
                            <input type="text" className="form-control" id="formGroupExampleInput" placeholder="Motivo de consulta" required/>
                            <label htmlFor="exampleFormControlTextarea1" className="form-label"></label>
                            <textarea className="form-control" id="plan" rows="3" placeholder="Ingrese aquí su consulta..." onChange={handleChange} value={formValues.plan}></textarea>
                        </div>
                        ...
                        <div className="col-12 mb-5 d-flex justify-content-end">
                            <button className="btn btn-cursos" type="submit" onSubmit={mostrarAlerta}>Enviar consulta</button>
                        </div>
                    </div>
                    </form>
